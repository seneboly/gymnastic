...
<tbody>
  ...
  <div class="body-title" style="padding: 20px 00"><b><u>Expéditeur</u></b> : {{$msg->name}},</div>
  <table class="body-text">
  <tbody>
  <tr>
  <td class="body-text-cell" style="width: 100%">
    <p style="text-align: justify; padding: 20px 00" ><b><u>Téléphone</u></b> :{{$msg->phone}}</p>
  </td>
  </tr>
  <tr style="padding: 30px 00">
      <td class="body-text-cell" style="width: 100%; padding: 20px 00">
        <p style="text-align: justify;"><b><u>Message</u></b> : {{$msg->content}}</p>
      </td>
  </tr>
<tr>
