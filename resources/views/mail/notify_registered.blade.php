...
<body bgcolor="#ffffff">
<div align="center">
<table class="head-wrap w320 full-width-gmail-android" border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fb5b21">
<tbody>
<tr>
...
<tr>
<p align="center">
  <a href="{{route('home')}}"><img src="{{asset('template/images/logo.png')}}" alt="logo"></a>
</p>
</tr>
</tbody>
</table>
...
<table class="status-container single" style="width:auto">
  <div class="row">
    <p>Bonjour,</p>
    <p style="padding:5px 00"><b> {{$msg['name']}} </b> vient de s'inscrire. <br> Ci-dessous vous trouverez les détails.</p>
  </div>
<tbody>
  ...
  <td class="body-text-cell" style="width: 100%">
    <p style="text-align: justify; padding: 10px 00" ><b><u>Téléphone</u></b> :{{$msg['phone']}}</p>
  </td>
  </tr>
  <tr style="padding: 30px 00">
      <td class="body-text-cell" style="width: 100%; padding: 10px 00">
        <p style="text-align: justify;"><b><u>Message</u></b> : {{$msg['email']}}</p>
      </td>
  </tr>
   <tr style="padding: 30px 00">
      <td class="body-text-cell" style="width: 100%; padding: 10px 00">
        <p style="text-align: justify;"><b><u>Adresse</u></b> : {{$msg['adresse']}}</p>
      </td>
  </tr>
  <tr style="padding: 30px 00">
      <td class="body-text-cell" style="width: 100%; padding: 10px 00">
        <p style="text-align: justify;"><b><u>Cours</u></b> :
...
<div style="text-align: left; padding: 30px 00"><a style="background-color: #41cc00; background-image: url('https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7'); border: 1px solid #407429; border-radius: 4px; color: #ffffff; display: inline-block; font-family: sans-serif; font-size: 17px; font-weight: bold; text-shadow: -1px -1px #47A54B; line-height: 38px; text-align: center; text-decoration: none; width: 190px; -webkit-text-size-adjust: none; mso-hide: all;" href="{{route('inscrits')}}">Aller sur le site</a></div>
